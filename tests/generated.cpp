...
void foo(LLVMContext &Ctx, Module &M) {
  ...
  auto *type_0x000000001E4CA3F8 = Type::getVoidTy(Ctx);
  auto *ret_type_0 = type_0x000000001E4CA3F8;
  std::vector<Type *> args_0;
  auto *type_0x000000001E4CA590 = Type::getIntNTy(Ctx, 64);
  args_0.push_back(type_0x000000001E4CA590);
  auto *type_0x000000001E4CEE90 = PointerType::get(Ctx, 0);
  args_0.push_back(type_0x000000001E4CEE90);
  ...
  auto *ret_type_1 = type_0x000000001E4CA3F8;
  std::vector<Type *> args_1;
  args_1.push_back(type_0x000000001E4CEE90);
  auto *type_0x000000001E4CA548 = Type::getIntNTy(Ctx, 8);
  args_1.push_back(type_0x000000001E4CA548);
  args_1.push_back(type_0x000000001E4CA590);
  auto *type_0x000000001E4CA530 = Type::getIntNTy(Ctx, 1);
  args_1.push_back(type_0x000000001E4CA530);
  ...
  auto *ret_type_2 = type_0x000000001E4CA3F8;
  std::vector<Type *> args_2;
  auto *type_0x000000001E4CA578 = Type::getIntNTy(Ctx, 32);
  args_2.push_back(type_0x000000001E4CA578);
  args_2.push_back(type_0x000000001E4CA578);
  args_2.push_back(type_0x000000001E4CA578);
  args_2.push_back(type_0x000000001E4CA578);
  ...
  auto *ret_type_3 = type_0x000000001E4CA3F8;
  std::vector<Type *> args_3;
  args_3.push_back(type_0x000000001E4CA578);
  args_3.push_back(type_0x000000001E4CA578);
  args_3.push_back(type_0x000000001E4CA578);
  auto *func_type_3 = FunctionType::get(ret_type_3, args_3, false);
  auto *func_3 =
      Function::Create(func_type_3, Function::ExternalLinkage, "put_cell", M);
  auto *ret_type_4 = type_0x000000001E4CA3F8;
  std::vector<Type *> args_4;
  args_4.push_back(type_0x000000001E4CA590);
  args_4.push_back(type_0x000000001E4CEE90);
  ...
  auto *ret_type_5 = type_0x000000001E4CA3F8;
  ...
  auto *ret_type_6 = type_0x000000001E4CA3F8;
  ...
  auto *func_6 = Function::Create(func_type_6, Function::ExternalLinkage,
                                  "destroy_sdl", M);
  auto *ret_type_7 = type_0x000000001E4CA578;
  ...
  auto *type_0x000000001E4CEEB0 = ArrayType::get(type_0x000000001E4CA548, 92);
  auto *type_0x000000001E4CEEE0 = ArrayType::get(type_0x000000001E4CEEB0, 92);
  auto *add_arg_46 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_49 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_51 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_53 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_55 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_57 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_8);
  auto *op_0_59 = type_0x000000001E4CEEE0;
  ...
  auto *phi_ty_63 = type_0x000000001E4CA578;
  ...
  auto *phi_ty_74 = type_0x000000001E4CA590;
  ...
  auto *op_2_77 = type_0x000000001E4CA578;
  ...
  auto *op_2_79 = type_0x000000001E4CA578;
  ...
  auto *phi_ty_84 = type_0x000000001E4CA590;
  ...
  auto *op_2_86 = type_0x000000001E4CA578;
  ...
  auto *op_2_89 = type_0x000000001E4CA578;
  ...
  auto *op_2_94 = type_0x000000001E4CA590;
  ...
  auto *op_2_96 = type_0x000000001E4CA578;
  ...
  auto *phi_ty_98 = type_0x000000001E4CA578;
  auto *phi_98 = builder.CreatePHI(phi_ty_98, 2, "");
  auto *instr_98 = phi_98;
  builder.SetInsertPoint(bb_16);
  auto *phi_ty_99 = type_0x000000001E4CA578;
  ...
  auto *op_2_101 = type_0x000000001E4CA590;
  ...
  auto *op_0_103 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_17);
  auto *op_0_104 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_108 = type_0x000000001E4CA578;
  auto *phi_108 = builder.CreatePHI(phi_ty_108, 3, "");
  auto *instr_108 = phi_108;
  builder.SetInsertPoint(bb_19);
  auto *phi_ty_109 = type_0x000000001E4CA578;
  ...
  auto *phi_ty_114 = type_0x000000001E4CA578;
  auto *phi_114 = builder.CreatePHI(phi_ty_114, 2, "");
  auto *instr_114 = phi_114;
  builder.SetInsertPoint(bb_21);
  auto *phi_ty_115 = type_0x000000001E4CA578;
  ...
  auto *op_2_117 = type_0x000000001E4CA590;
  auto *instr_117 = builder.CreateCast(op_0_117, op_1_117, op_2_117);
  builder.SetInsertPoint(bb_21);
  auto *op_0_118 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_21);
  auto *op_0_119 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_123 = type_0x000000001E4CA578;
  ...
  auto *op_2_126 = type_0x000000001E4CA590;
  auto *instr_126 = builder.CreateCast(op_0_126, op_1_126, op_2_126);
  builder.SetInsertPoint(bb_23);
  auto *op_0_127 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_23);
  auto *op_0_128 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_132 = type_0x000000001E4CA578;
  ...
  auto *op_0_136 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_26);
  auto *op_0_137 = type_0x000000001E4CA548;
  ...
  auto *op_2_139 = type_0x000000001E4CA578;
  ...
  auto *phi_ty_146 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_152 = type_0x000000001E4CA590;
  ...
  auto *phi_ty_157 = type_0x000000001E4CA590;
  auto *phi_157 = builder.CreatePHI(phi_ty_157, 2, "");
  auto *instr_157 = phi_157;
  builder.SetInsertPoint(bb_33);
  auto *op_0_158 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_33);
  auto *op_0_159 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_162 = type_0x000000001E4CA548;
  ...
  builder.SetInsertPoint(bb_36);
  auto *op_0_166 = type_0x000000001E4CEEB0;
  ...
  builder.SetInsertPoint(bb_36);
  auto *op_0_167 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_170 = type_0x000000001E4CA548;
  ...
  auto *phi_ty_182 = type_0x000000001E4CA590;
  auto *phi_182 = builder.CreatePHI(phi_ty_182, 2, "");
  auto *instr_182 = phi_182;
  builder.SetInsertPoint(bb_42);
  auto *op_0_183 = type_0x000000001E4CEEE0;
  ...
  builder.SetInsertPoint(bb_42);
  auto *op_0_184 = type_0x000000001E4CA548;
  ...
  auto *op_2_186 = type_0x000000001E4CA578;
